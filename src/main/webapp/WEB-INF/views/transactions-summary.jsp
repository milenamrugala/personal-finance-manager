...
<h2>Total expenses: ${totalExpense}</h2><br>
<h2>Balance: ${balance}</h2><br>
<h2>Number of income transactions: ${numIncomeTransactions}</h2><br>
<h2>Number of expense transactions: ${numExpenseTransactions}</h2><br>
